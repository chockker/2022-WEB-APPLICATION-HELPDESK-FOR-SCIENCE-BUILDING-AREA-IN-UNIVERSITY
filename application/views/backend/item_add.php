                ...
                <div class="col-sm-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            ...
                            <!-- form start -->
                            <form role="form" action="<?= site_url('item/adding'); ?>" method="post" class="form-horizontal">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text" name="i_name" class="form-control" required placeholder="กรุณากรอกชื่ออุปกรณ์"  minlength="1"  value="<?= set_value('i_name'); ?>">
