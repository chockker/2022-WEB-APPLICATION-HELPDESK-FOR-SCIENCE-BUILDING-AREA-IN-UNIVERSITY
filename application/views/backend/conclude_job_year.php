        ...
        <div class="box" style="font-family:'Mitr', sans-serif">
            <div class="box-header">      
                ...
                <style type="text/css">
                    ...
                    <div class="col-sm-12">
                        <form role="form" action="<?= site_url('conclude/view_by_year'); ?>" method="post">
                        <div class="form-group">
                            <div class="form-group">
                                <div class="col-sm-1">
                                    <input id="hid" type="text" name="yy_date"  class="form-control" required minlength="4" pattern="^[0-9]+$" placeholder="กรุณาใส่ปีค.ศ." value="<?=set_value('yy_date');?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-3 " >
                            ...
                            <div class="col-sm-8" style="display: flex;justify-content: flex-end;align: right;">
                                <div class="form-group" >
                        ...
                        <div class="col-sm-12">
                            <h3 class="box-title" style="font-family:'Mitr', sans-serif">ข้อมูลของปี :<font color="red" ><?=set_value('yy_date');?></font></h3>
                        </div>
                    </div>
