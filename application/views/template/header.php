    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="col-sm-12 " style="color:#FFFFFF;text-align:center">
          ...
          <a href="#"><i class="fa fa-circle text-success" ></i> ผู้ดูแล</a>
        </div>
      </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header">MENU</li>
           ...
           <li><a href="<?= site_url('addjobs');?>"><i class="fa fa-plus-circle"></i> <span>เพิ่มประเภทงาน</span></a></li>
           ...
           <li><a href="<?= site_url('admin');?>"><i class="fa fa-user-plus"></i> <span>เจ้าหน้าที่</span></a></li>
